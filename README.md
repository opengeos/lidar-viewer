...
```
https://lidar-viewer.gishub.org/index.html?url=https://s3.amazonaws.com/hobu-lidar/autzen-classified.copc.laz
```

### Sample Datasets

- [Autzen Stadium (Oregon)](https://lidar-viewer.gishub.org/index.html?url=https://s3.amazonaws.com/hobu-lidar/autzen-classified.copc.laz)
- [Madison (Wisconsin)](https://lidar-viewer.gishub.org/index.html?url=https://data.opengeos.org/madison.copc.laz)
- [Texas Coastal Region](https://lidar-viewer.gishub.org/index.html?url=https://data.opengeos.org/USGS_LPC_TX_CoastalRegion_2018_A18_stratmap18-50cm-2995201a1.copc.laz)
